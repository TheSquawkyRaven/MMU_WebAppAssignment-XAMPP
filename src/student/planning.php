...
<body>
    ...
    <div class="detail-container">
        <div class="table-detail">
            <div class="header">
                <h2>Goal Setting</h2> <button class="btn-1" id="add-proposal">New Goal</button>
            </div>
            <div class="nav-1">
                <ul>
                    <li id="pending-proposal" class="btn-2 current">All Goal</li>
                </ul>
            </div>
        ...
        <div class="form-container">
            <div class="table-detail">
                ...
                <div class="project-detail">
                    <div><label>Goal ID: </label><span id="project-id"></span></div>
                    <div><label>Task Name: </label><span id="task-name"></span></div>
					<div><label>Category: </label><span id="category"></span></div>
					<div><label>Status: </label><span id="status"></span></div>
					<div><label>Start Date: </label><span id="start-date"></span></div>
                </div>
